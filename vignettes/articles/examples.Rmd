...
Each example ships with the package — run it locally with the `iridExample()` call shown, or open it in the [Shinylive](https://shinylive.io/) editor. Call `iridExample()` with no argument to list them all.
