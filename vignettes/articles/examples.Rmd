...
Every example also ships with the package — run any of them locally with the `iridExample()` call shown under each. Call `iridExample()` with no argument to list them all.
